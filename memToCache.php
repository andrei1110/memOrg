<?php
	...
	echo '<th id="cache-adr-'.$result['cache'].'" onClick="toChange('."'".$result['info']."'".')">'.str_pad(decbin($result['cache']), CACHEADRESS, "0", STR_PAD_LEFT).'</th>';
	echo '<td id="cache-tag-'.$result['cache'].'" onClick="toChange('."'".$result['info']."'".')">'.$result['missorhit'].'</td>';
